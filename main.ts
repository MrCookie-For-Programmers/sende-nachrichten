...
basic.forever(function () {
    if (Alphabet_warum == 0) {
        ...
        basic.showString("@")
    } else if (Alphabet_warum == 44) {
        basic.showNumber(1)
    } else if (Alphabet_warum == 45) {
        basic.showNumber(2)
    } else if (Alphabet_warum == 46) {
        basic.showNumber(3)
    } else if (Alphabet_warum == 47) {
        basic.showNumber(4)
    } else if (Alphabet_warum == 48) {
        basic.showNumber(5)
    } else if (Alphabet_warum == 49) {
        basic.showNumber(6)
    } else if (Alphabet_warum == 50) {
        basic.showNumber(7)
    } else if (Alphabet_warum == 51) {
        basic.showNumber(8)
    } else if (Alphabet_warum == 52) {
        basic.showNumber(9)
    } else if (Alphabet_warum == 53) {
        basic.showNumber(0)
    }
})
basic.forever(function () {
